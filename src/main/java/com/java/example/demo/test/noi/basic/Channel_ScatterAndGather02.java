 ...
 */
public class Channel_ScatterAndGather02{

	@Test
	public void ScatterAndGather() throws IOException {
		RandomAccessFile fos=new RandomAccessFile("src/main/resources/1.txt","rw");
		...
		//聚集写入：Gather	
		RandomAccessFile fos1=new RandomAccessFile("src/main/resources/22.txt","rw");
